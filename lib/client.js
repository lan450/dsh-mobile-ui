...
`;
	...
	.${c.crumbCurrent} { flex: 1 1 auto !important; min-width: 0 !important; max-width: none !important; overflow: hidden !important; text-overflow: ellipsis !important; white-space: nowrap !important; text-align: left !important; order: 0 !important; }
	...
	/* 父级面包屑（子代理会话）与层叠分隔符：第二行 */
	.${c.crumb}:not(.${c.crumbCurrent}) { flex: 0 1 auto !important; min-width: 0 !important; text-align: left !important; order: 2 !important; }
	.${c.crumbSep} { flex: 0 0 auto !important; order: 2 !important; }
	/* 标准模式 + 后台任务：第二行（在层叠之后折行堆叠） */
	.${c.headerActions} { flex: 1 1 auto !important; min-width: 0 !important; order: 3 !important; flex-wrap: wrap !important; }
...
`;
	...
	.${c.root}.${c.switcherRoot} { flex: 1 1 auto !important; min-width: 0 !important; order: 0 !important; }
	.${c.root}.${c.switcherRoot} .${c.switcherTitle} { max-width: none !important; }
	.${c.root}:not(.${c.switcherRoot}) { flex: 0 1 auto !important; min-width: 0 !important; order: 2 !important; }
`;
				},
			},
			{
